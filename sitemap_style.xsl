    ...
    <xsl:template match="/">
        <html>
            <head>
                ...
                <link rel="stylesheet" href="https://chandara.keybase.pub/resources/bare-bones.css"/>
            </head>
            <body style="max-width: 800px; margin: 0 auto;">
                <header>
                    <div>
                        <h1>this is a sitemap</h1>
                    ...
                    <!--         </xsl:when> -->
                    <!--         <xsl:otherwise> -->
                    <!--             This index contains <strong><xsl:value-of select="count(sitemap:urlset/sitemap:url)"/> URLs</strong>. -->
                    <!--         </xsl:otherwise> -->
                    <!--     </xsl:choose> -->
                    <!-- </h4> -->
                    <p>A <i>sitemap</i> is a file where you provide information about the pages, videos, and other files on your site, and the relationships between them. Search engines like Google read this file to crawl your site more efficiently.</p>
                </header>

                <xsl:apply-templates/>

                <footer>
                    The design of this webpage is based on a theme named <i>Santa Fe, CO</i> and is designed by <a href="https://github.com/wholesome-wiz">John Chandara</a>, based off foundational code from  <a href="https://github.com/pedroborges" title="Check out the creator">Pedro Borges</a>. 
                </footer>
