...
KB_MOUNTDIR=$(keybase config get mountdir | grep -Eo "[\/a-z0-9]+")
KB_MOUNTDIR="$KB_MOUNTDIR/public/$username"
cwd="$(pwd)"
...
echo "$KB_MOUNTDIR/Resources/web.min.css"
...
<style>$(cat $KB_MOUNTDIR/Resources/web.min.css)</style>
...
<h1><a href=\".\"><img src=\"https://github.com/wholesome-wiz/Santa-Monica-CO/raw/main/thumbnails/icons8-folder-48.png\" style=\"width: 42px; margin-right: .25rem; transform: translateY(10px)\"> $www_path</a></h1>
</div>
